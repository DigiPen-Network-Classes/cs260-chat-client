...
namespace ColorLibrary {
    ...
    enum class Shade : int {
        S50, S100, S200, S300, S400,
        S500, S600, S700, S800, S900, S950,
        COUNT
    };

    constexpr RGB Colors[static_cast<int>(Hue::COUNT)][static_cast<int>(Shade::COUNT)] = {
        // Neutral
        { {250,250,250}, {245,245,245}, {229,229,229}, {212,212,212}, {163,163,163},
          {115,115,115}, { 82, 82, 82}, { 64, 64, 64}, { 38, 38, 38}, { 23, 23, 23}, { 10, 10, 10} },
          // Stone
          { {250,250,249}, {245,245,244}, {231,229,228}, {214,211,209}, {168,162,158},
          {120,113,108}, { 87, 83, 78}, { 68, 64, 60}, { 41, 37, 36}, { 28, 25, 23}, { 12, 10,  9} },
          // Zinc
          { {250,250,250}, {244,244,245}, {228,228,231}, {212,212,216}, {161,161,170},
          {113,113,122}, { 82, 82, 91}, { 63, 63, 70}, { 39, 39, 42}, { 24, 24, 27}, {  9,  9, 11} },
          // Slate
          { {248,250,252}, {241,245,249}, {226,232,240}, {203,213,225}, {148,163,184},
          {100,116,139}, { 71, 85,105}, { 51, 65, 85}, { 30, 41, 59}, { 15, 23, 42}, {  2,  6, 23} },
          // Gray
          { {249,250,251}, {243,244,246}, {229,231,235}, {209,213,219}, {156,163,175},
          {107,114,128}, { 75, 85, 99}, { 55, 65, 81}, { 31, 41, 55}, { 17, 24, 39}, {  3,  7, 18} },
          // Red
          { {254,242,242}, {254,226,226}, {254,202,202}, {252,165,165}, {248,113,113},
          {239, 68, 68}, {220, 38, 38}, {185, 28, 28}, {153, 27, 27}, {127, 29, 29}, { 69, 10, 10} },
          // Orange
          ...
          // Yellow
          { {254,252,232}, {254,249,195}, {254,240,138}, {253,224, 71}, {250,204, 21},
          ...
          {236, 72,153}, {219, 39,119}, {190, 24, 93}, {157, 23, 77}, {131, 24, 67}, { 80,  7, 36} },
          // Rose
          { {255,241,242}, {255,228,230}, {254,205,211}, {253,164,175}, {251,113,133},
          {244, 63, 94}, {225, 29, 72}, {190, 18, 60}, {159, 18, 57}, {136, 19, 55}, { 76,  5, 25} },
    };

    constexpr Clay_Color Get(Hue hue, Shade shade, float alpha = 255) {
        RGB color = Colors[static_cast<int>(hue)][static_cast<int>(shade)];
        return { static_cast<float>(color.r), static_cast<float>(color.g), static_cast<float>(color.b), alpha };
    }

    // aliases
    namespace Constants {
        constexpr RGB Danger = Colors[static_cast<int>(Hue::Red)][static_cast<int>(Shade::S500)];
        constexpr RGB Success = Colors[static_cast<int>(Hue::Green)][static_cast<int>(Shade::S500)];
        constexpr RGB Warning = Colors[static_cast<int>(Hue::Amber)][static_cast<int>(Shade::S500)];
        constexpr RGB Info = Colors[static_cast<int>(Hue::Blue)][static_cast<int>(Shade::S500)];
    }
}